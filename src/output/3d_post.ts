...
import {RenderTarget, Mesh3d, Geometry, Cube, shaders, Layer3d} from 'sprite-extend-3d';
...
function getSupportedFormat(gl: WebGL2RenderingContext, internalFormat: any, format: any, type: any): any {
...
function supportRenderTextureFormat(gl: WebGL2RenderingContext|WebGLRenderingContext, internalFormat: any, format: any, type: any) {
...
const gl = layer.gl as WebGL2RenderingContext;
