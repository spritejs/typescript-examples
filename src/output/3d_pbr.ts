...
import {Mesh3d, Plane, Layer3d} from 'sprite-extend-3d';
...
const exteriorSettings: any = {};
const interiorSettings: any = {};
...
function loadModels({models, settings}: any) {
  models = models.map((model: any) => layer.loadModel(model));
